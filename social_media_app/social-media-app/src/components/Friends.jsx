...
const Friends = () => {
  ...
  return (
    <div className="sticky hidden flex-1 items-start justify-start xl:flex">
      <div className="sticky top-10 flex w-full flex-col gap-5 rounded-3xl border bg-white p-5 text-center dark:border-gray-700 dark:bg-black dark:text-white md:w-5/6">
        <h3 className="text-4xl font-semibold">Friends</h3>
        <ul className="flex w-full flex-col gap-5">
          {friendsList.map((friend, index) => (
            <li
              key={index}
              className="flex cursor-pointer flex-wrap items-center justify-between gap-5 rounded-3xl bg-gray-100 p-3 transition-all duration-300 hover:bg-gray-200 dark:bg-gray-900 dark:hover:bg-gray-800"
            >
